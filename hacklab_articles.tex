...
\section{General}
\subsection{Name}
\clause{The name of the organisation shall be ``57 North Hacklab Ltd'', 
...
\clause{Membership is said of cease upon the death of the member}
...
\clause{\label{clause:proxy}Proxies may only validly be appointed by a notice in writing (a â€œproxy noticeâ€)
which}
