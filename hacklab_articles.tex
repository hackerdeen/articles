...
\begin{titlepage}
  \vspace*{\fill}
  \begin{center}
    \includegraphics[width=0.35\textwidth]{logo.pdf}\\[1cm]
...
\subsubclause{his/her full name and address(postal and e-mail); and}
...
\clause{The quorum for a general meeting is 5 members or one quarter of the
...
\clause{A person who has served on the board for a period of 3 years
  shall automatically vacate office on expiry of that 3 year period.}
...
\subclause{he/she becomes incapable for medical reasons of carrying
  out his/her duties as a director - but only if that has continued
...
\subclause{by reason of that person's mental health, a court makes an
  order which wholly or partly prevents him/her from personally
  exercising any powers or rights which he/she would otherwise have;}
...
\subclause{for each former director - for at least 6 years from the
  date on which he/she ceased to be a director:}
...
\clause{\label{clause:directoremployee}No director may be given any
  remuneration by the Hacklab for carrying out his/her duties as a
  director.}
...
\clause{Each directors has one vote, which must be given in person.}
...
\clause{The board may, at its discretion, allow any person to attend
  ...
  director - but on the basis that he/she must not participate in
  decision-making.}
...
\clause{\label{clause:conflictofinterest}A director must not vote at a
  ...
  which relates to a matter in which he/she has a personal interest or
  duty which conflicts (or may conflict) with the interests of the
  Hacklab; he/she must withdraw from the meeting while an item of that
...
\clause{For the purposes of clause \ref{clause:conflictofinterest}: a
  ...
  particular matter if a body in relation to which he/she is an
