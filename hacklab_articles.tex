...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\large 23\textsuperscript{rd} January 2023}
  \end{center}
  \vspace*{\fill}
\end{titlepage}
\section{General}
...
or transferred (directly or indirectly) to the members except where
this is done in direct furtherance of the Hacklab's purposes or on
dissolution of the Hacklab per clause \ref{clause:windingup}.}
...
member or within one year after they cease to be a member, for:}
  \begin{enumerate}
  \item
...
resides further than 80 kilometres, in a straight line, from 35A Union Street, 
Aberdeen.}
...
\clause{If a subscription payable by any member remains outstanding more 
  than 2 months after the date on which it fell due - and providing they have 
  been given at least one reminder (either in writing or by e-mail) - the board 
  may, by resolution to that effect, expel them from membership. If a 
  subscription payable by any member remains outstanding more than 12 
  months after the date on which it fell due, the member shall be expelled 
  from the membership.}
...
\subsection{Treasurer and Membership Secretary}

\clause{One of the directors shall be the treasurer.}

\clause{One of the directors shall be the membership secretary.}

\clause{A person elected to be treasurer or the membership secretary
will automatically cease to hold that office:}
...
\clause{\label{clause:boardelection}At each AGM, the members may elect
  ...
  \ref{clause:disqualified}) to be the treasurer, the membership secretary,
  or one of the other directors.}
...
\subsubclause{whether they are the treasurer; and}

\subsubclause{whether they are the membership secretary.}
...
\subsubclause{whether they were the membership secretary; and}
...
\clause{\label{clause:conflictofinterest}A director must not vote at a
  ...
  which relates to a matter in which they have a personal interest or
...
\clause{\label{clause:signatories}Subject to clause
  ...
  held by the Hacklab. Approval for operations should be sought either
  at a board meeting or on the committee mailing list. On the mailing
  list an email from a director (signed with their PGP key) can
  indicate approval or opposition. Two approvals are required for an
  action to be approved unless a majority of the board is opposed to
  the action. 7 calendar days will be allowed for opposition to be
  lodged.}
...
\clause{\label{clause:windingup}Any surplus assets available to the 
Hacklab immediately preceding its winding up or dissolution must be 
distributed amongst members in a manner proportional to members
contributions to that surplus, dating back 5 years from the date of 
dissolution.}
